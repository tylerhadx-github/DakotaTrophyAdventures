<template>
  <div>
    <v-card>
      ...
      <v-card-text>
        <v-row>
          <v-col v-for="(review, index) in testimonials" :key="index" md="6" cols="12" class="offset-md-3">
            <v-card flat>
              <v-card-text>
                <div v-for="i in review.images">
                  <v-img :src="''"></v-img>
                </div>
      ...
      <v-col>
        <v-card>
          ...
          <v-card-text style="justify-content: center;">
            <div style="color: black; align-content: center;text-align: center;" v-html="PheasantHunting"></div>
          </v-card-text>
        </v-card>
        ...
        <v-card>
          ...
          <v-card-text>
            <div style="color: black; align-content: center;text-align: center;" v-html="BigGame"></div>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
