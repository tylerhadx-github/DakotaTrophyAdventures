  ...
  <div>
    <v-row>
      <v-col>
        <v-card>
         <!-- <v-card-title >
                 The Best Kept Secret Of Hunting In The West
          </v-card-title> -->
          <v-card-text>
            <div  v-html="Home"  style="color: rgb(0, 0, 0); font-family: Tahoma, Geneva, sans-serif; font-size: medium;"></div>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
